#### Modified from https://github.com/lihualei71/dbhPaper/blob/master/R/HIV_preprocess.R
...
for (drug_class in c("PI", "NRTI", "NNRTI")){
  ...
  ## Had to add '_wrapper' to this URL to get it to work, the website might have been moved?
  gene_url <- paste('https://hivdb.stanford.edu/_wrapper/pages/published_analysis/genophenoPNAS2006', 'DATA', paste0(drug_class, '_DATA.txt'), sep = '/')
